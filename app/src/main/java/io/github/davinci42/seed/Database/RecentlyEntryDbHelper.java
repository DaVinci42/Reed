 ...
 */
public class RecentlyEntryDbHelper extends SQLiteOpenHelper {

	private static final int VERSION = 1;
	private static final String DATABASE_NAME = EntryDbSchema.DB_NAME;

	private static final String SQL_CREATE_ENTRIES =
		"CREATE TABLE IF NOT EXISTS " + EntryDbSchema.EntryTable.RECENTLY_TABLE_NAME + "(" +
	...
	private static final String SQL_DELETE_ENTRIES =
		"DROP TABLE IF EXISTS " + EntryDbSchema.EntryTable.RECENTLY_TABLE_NAME;

	public RecentlyEntryDbHelper(Context context) {
